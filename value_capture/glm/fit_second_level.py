...
CONTRASTS = [
    ...
    ('feedback',        '(feedback_rank{0,1,2}_shown + feedback_absent_shown) / 4 − feedback_omitted',
    ...
    ('feedback_step_low',  'feedback_rank1_shown − feedback_rank0_shown',
     'Value-dependent feedback — medium vs low value rank at feedback phase'),
    ('feedback_step_high', 'feedback_rank2_shown − feedback_rank1_shown',
     'Value-dependent feedback — high vs medium value rank at feedback phase'),
]
